...
class _PopupMenuRouteLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    if (height != null) {
      ...
      return BoxConstraints.loose(Size(constraints.biggest.width, constraints.biggest.height));
    }
  }
...
class CustomPopupMenuButtonState<T> extends State<CustomPopupMenuButton<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.child != null
        ? InkWell(
            onTap: widget.enabled ?? true ? showButtonMenu : null,
            child: widget.child,
          )
        : IconButton(
            ...
            onPressed: widget.enabled ?? true ? showButtonMenu : null,
          );
  }
}
