...
import 'package:base_pm2/screen/report/comp/date_range_comp.dart';
...
class ReportOptionComp extends GetView<OptionController> {
  ReportOptionComp({Key? key}) : super(key: key) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() => DateRangeComp(
                onChangeDate: controller.onPicker,
                startTime: controller.pickTimeModel?.rxStartTime?.value,
                endTime: controller.pickTimeModel?.rxEndTime?.value,
              )),
          ...
          const SizedBox(height: 8),
          const ItemReportComp<OptionController>(),
          const SizedBox(height: 26),
          Obx(
            () => Visibility(
              child: Column(
                ...
                children: [
                  ...
                  !Utils.isNotNullAndEmpty(controller.mReport.value?.reportModels)
                      ...
                      :   GestureDetector(
                      onTap: () =>
                          Get.toNamed(RoutePath.ACCESS_HISTORY, parameters: controller.getParamForHistory()),
                  ...
                  //   child: ChartNoteComp(
                  //       data:
                  //           controller.mReport.value?.apps?.mapIndexed<ChartData>(_buildNoteReport).toList()),
                  // ),
                  const SizedBox(height: 8),
                ],
              ),
