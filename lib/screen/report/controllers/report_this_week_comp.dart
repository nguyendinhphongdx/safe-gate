...
class ReportThisWeekComp extends GetView<ThisWeekController> {
  ReportThisWeekComp({Key? key}) : super(key: key) {
    Get.lazyPut(() => ThisWeekController());
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ItemReportComp<ThisWeekController>(),
          const SizedBox(height: 26),
          Obx(
            () => Column(
