...
class ReportYesterdayComp extends GetView<YesterdayController> {
  ReportYesterdayComp({Key? key}) : super(key: key) {
    Get.lazyPut(() => YesterdayController());
  }
        ...
        children: [
          ...
          Obx(
            () => SingleChildScrollView(
              ...
              child: Row(
                children: controller.mProfiles
                    .mapIndexed<Widget>(_itemBuilder)
                    .toList(),
              ),
            ),
          ),
          ...
          Row(
            children: [
              Text(KeyLanguage.overview.tr,
                  style: appStyle.textTheme.bodyText1),
              const Expanded(child: SizedBox()),
            ],
          ),
          const SizedBox(height: 8),
          const ItemReportComp<YesterdayController>(),
          const SizedBox(height: 26),
          Obx(
            () => Column(
              ...
              children: [
                Row(
                  children: [
                    Text(KeyLanguage.condition_use.tr,
                        style: appStyle.textTheme.bodyText1),
                    const Expanded(child: SizedBox()),
                  ],
                ),
                ...
                //   scrollDirection: Axis.horizontal,
                //   child: ChartNoteComp(
                //       data: controller.mReport.value?.apps
                //           ?.mapIndexed<ChartData>(_buildNoteReport)
                //           .toList()),
                // ),
